...
void Utils::ShowMessagebox(const char* message, const char* title)
{
	 auto print = reinterpret_cast<void(__stdcall*)(const char*, const char*)>(FindPatternIDA("client.dll", "55 8B EC 8B 0D ? ? ? ? 6A 00 6A 00"));
	 print(message, title);
}